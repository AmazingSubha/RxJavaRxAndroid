package com.glistersoft.rxjavarxandroid.note_app.view;
...
import com.glistersoft.rxjavarxandroid.note_app.network.ApiClient;
import com.glistersoft.rxjavarxandroid.note_app.network.ApiService;
import com.glistersoft.rxjavarxandroid.note_app.network.model.Note;
import com.glistersoft.rxjavarxandroid.note_app.network.model.User;
import com.glistersoft.rxjavarxandroid.note_app.utils.MyDividerItemDecoration;
import com.glistersoft.rxjavarxandroid.note_app.utils.PrefUtils;
import com.glistersoft.rxjavarxandroid.note_app.utils.RecyclerTouchListener;
...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * */
       /* PrefUtils.storeApiKey(getApplicationContext(), "bb41c39f50c885bfa575252be55da49a");
        fetchAllNotes();*/
    ...
    private void showNoteDialog(final boolean shouldUpdate, final Note note, final int position) {
        ...
        AlertDialog.Builder alertDialogBuilderUserInput = new AlertDialog.Builder(NoteActivity.this);
        ...
        alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(inputNote.getText().toString())) {
                    Toast.makeText(NoteActivity.this, "Enter note!", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    alertDialog.dismiss();
                }
